...
public class SingleMemApp extends BaseClass {
   ...
   lgnpage= new createaccfunc(d);
	...
	public void testcase1(String Uname,String pswd,String Fname,String Lname,String dob,String sex,String addrl1,  String ct,  String st,String zip1,String elig,String ssn,String enrlmnt,String newmem,String incmtyp,String amt,String freq,String stdate) throws Exception{
	...
	//secpage.filing_ans1();
	 ...
	 @DataProvider (name="testcase")
	  ...
	  public Object[][] reg() throws Exception
	  {
		...
		Object[][] testObjArray = ExcelUtilities.getTableArray2(".\\TestData\\Training.xlsx","Sheet10", 2,18);
